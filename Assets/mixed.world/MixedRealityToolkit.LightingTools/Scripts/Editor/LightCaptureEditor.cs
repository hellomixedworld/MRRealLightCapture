...
namespace Microsoft.MixedReality.Toolkit.LightingTools
{
	...
	public class LightCaptureEditor : UnityEditor.Editor
	{
		...
		private SerializedProperty useMediaProjection;
		private SerializedProperty mediaprojectionTexture;
		...
		private void OnEnable()
		{
			...
			useMediaProjection = serializedObject.FindProperty("useMediaProjection");
			mediaprojectionTexture = serializedObject.FindProperty("mediaprojectionTexture");
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.PropertyField(useMediaProjection);
			EditorGUILayout.PropertyField(mediaprojectionTexture);
